        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-xs space-y-3">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div className="relative group shrink-0">
              <div className="w-16 h-16 rounded-xl bg-slate-100 border-2 border-slate-200 overflow-hidden flex items-center justify-center shadow-xs">
          ...
          <div className="pt-3 border-t border-slate-100">
            ...
            <div className="flex items-center gap-2">
              <label className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl cursor-pointer text-[11px] font-medium text-slate-700 transition-all truncate">
